...
<main class="main">
			...
			<div class="row row--grid">
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Set up your wallet</h3>
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Create your collection</h3>
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Add your NFTs</h3>
		...
		<div class="main__video-bg" data-bg="img/bg/bg2.png" style="background: url(&quot;img/bg/bg2.png&quot;) center center / cover no-repeat;">
			<div class="container">
				<div class="row">
					<div class="col-12 col-lg-8 col-xl-8">
						<div class="main__title">
							...
							<a href="https://vimeo.com/45830194" class="main__video open-video">Watch video</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row--grid">
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						...
						<h3 class="feature__title">Create and sell</h3>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						<span class="feature__icon feature__icon--red">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2.5,10.56l9,5.2a1,1,0,0,0,1,0l9-5.2a1,1,0,0,0,0-1.73l-9-5.2a1,1,0,0,0-1,0l-9,5.2a1,1,0,0,0,0,1.73ZM12,5.65l7,4-7,4.05L5,9.69Zm8.5,7.79L12,18.35,3.5,13.44a1,1,0,0,0-1.37.36,1,1,0,0,0,.37,1.37l9,5.2a1,1,0,0,0,1,0l9-5.2a1,1,0,0,0,.37-1.37A1,1,0,0,0,20.5,13.44Z"></path></svg>
						</span>
						<h3 class="feature__title">Collect NFTs</h3>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						...
						<h3 class="feature__title">Get airdrop <br>as Unitok user</h3>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						...
						<h3 class="feature__title">Get airdrop <br>as NFT holder</h3>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						<span class="feature__icon">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7,6H6V3A1,1,0,0,0,4,3V6H3A1,1,0,0,0,3,8H7A1,1,0,0,0,7,6ZM5,10a1,1,0,0,0-1,1V21a1,1,0,0,0,2,0V11A1,1,0,0,0,5,10Zm7,8a1,1,0,0,0-1,1v2a1,1,0,0,0,2,0V19A1,1,0,0,0,12,18Zm9-8H20V3a1,1,0,0,0-2,0v7H17a1,1,0,0,0,0,2h4a1,1,0,0,0,0-2Zm-2,4a1,1,0,0,0-1,1v6a1,1,0,0,0,2,0V15A1,1,0,0,0,19,14Zm-5,0H13V3a1,1,0,0,0-2,0V14H10a1,1,0,0,0,0,2h4a1,1,0,0,0,0-2Z"></path></svg>
						</span>
						<h3 class="feature__title">Hustle in Unitok DAO</h3>
						<p class="feature__text">It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially</p>
					</div>
				</div>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						...
						<h3 class="feature__title">Vote for platform upgrades</h3>
						<p class="feature__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose</p>
					</div>
				</div>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature">
						...
						<h3 class="feature__title">Choose featured artworks</h3>
						<p class="feature__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose</p>
					</div>
				</div>
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-3">
					<div class="feature feature--last">
						...
						<h3 class="feature__title">Participate <br>in moderation</h3>
						<p class="feature__text">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing</p>
					</div>
				</div>
			</div>
		</div>
