    ...
    <div class="row row--grid">
      ...
      <div class="col-12 col-xl-11">
        <div class="main__title main__title--page">
          ...
          <p>Many desktop publishing packages and <a href="#">web page</a> editors now use Lorem Ipsum as their default
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="knowledge">
          <h3 class="knowledge__title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
    ...
    <div class="row row--grid">
      <div class="col-12 col-lg-4">
        <div class="faq">
          ...
          <p class="faq__text">All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as
            necessary, making this the first true generator on the Internet.</p>
          <p class="faq__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose
            (injected humour and the like).</p>
        </div>

        <div class="faq">
          <h3 class="faq__title">When and how do you get paid?</h3>
          <p class="faq__text">Many desktop publishing packages and web page editors now use Lorem Ipsum as their
      ...
      <div class="col-12 col-lg-4">
        <div class="faq">
          ...
          <p class="faq__text">There are many variations of passages of Lorem Ipsum available, but the majority have
        ...
        <div class="faq">
          ...
          <p class="faq__text">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
            anything embarrassing hidden in the middle of text.</p>
        </div>

        <div class="faq">
          <h3 class="faq__title">Which servers are available?</h3>
          <p class="faq__text">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of
      ...
      <div class="col-12 col-lg-4">
        <div class="faq">
          ...
          <p class="faq__text">It was popularised in the 1960s with the release of Letraset sheets containing Lorem
