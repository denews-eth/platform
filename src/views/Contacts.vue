    ...
    <div class="row row--grid">
      ...
      <div class="col-12 col-md-6 col-lg-5 col-xl-4">
        <div class="main__title main__title--sidebar">
          <h2>Info</h2>
          <p>It is a long fact that a reader will be distracted by the readable content of a page when looking at its
            layout</p>
        </div>
        <ul class="contacts__list">
          <li><a href="tel:88002345678">8 800 234-56-78</a></li>
          <li><a href="mailto:support@Unitok.com">support@Unitok.com</a></li>
          <li><a
        ...
        <div class="contacts__social">
          ...
          <a href="#" target="_blank"><svg viewBox="0 0 18 13" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="mailto:support@Unitok.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
